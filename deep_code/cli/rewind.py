...
from deep_code.security.checkpoint import CheckpointManager, CheckpointNotFoundError
...
def create_rewind_manager(
    ...
    Uses default checkpoint directory (.deepcode/checkpoints/).

    Args:
        checkpoint_dir: Optional checkpoint directory (defaults to .deepcode/checkpoints/)
