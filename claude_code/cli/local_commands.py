"""
Local command handling for Claude Code Python MVP
...
from claude_code.cli.utils import resolve_under_root, format_dir_listing

if TYPE_CHECKING:
    from claude_code.core.agent import Agent
